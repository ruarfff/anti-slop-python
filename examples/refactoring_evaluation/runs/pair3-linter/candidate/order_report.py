...
The implementation is split by responsibility while these imports preserve the
original module's public interface for callers and scripts.
"""
...
from demo import demo_report, load_report
